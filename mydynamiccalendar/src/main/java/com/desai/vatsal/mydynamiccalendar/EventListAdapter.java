...
public class EventListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class EventViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout ll_month_events, ll_event_image;
...
//                    tv.setBackgroundResource(model.getImage());
//                    ll_event_image.addView(tv);
                    tv_event_simbol.setBackgroundResource(model.getImage());
//                    tv_event_simbol.getLayoutParams().width = 8;
//                    tv_event_simbol.getLayoutParams().height = 8;
                } else {
