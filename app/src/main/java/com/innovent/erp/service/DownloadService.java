...
public class DownloadService extends IntentService {
        ...
        protected void onPostExecute(Integer file_url) {
            try {
                ...
                if (file_success.equals("success")) {
                    Toaster.show(DownloadService.this, "Download Successfully In Your " + GlobalElements.directory_document + " Folder In Sdcard", true, Toaster.SUCCESS);
                } else {
    ...
    public class DisplayToast1 implements Runnable {
        ...
        public void run() {
            Toaster.show(mContext, "Your download in progress please check notification bar for progress", false, Toaster.SUCCESS);
        }
    }
