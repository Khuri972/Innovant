...
public class SearchDistrictAdapter extends BaseAdapter implements Filterable {
    ...
    public Object getItem(int i) {
        return suggestions.get(i).getDistrict();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            name.setText("" + suggestions.get(position).getDistrict());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return vi;
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                try {
                    ...
                    if (constraint != null) {
                        ...
                        List<AreaModel> new_suggestions = jp.searDistrict(constraint.toString());
                        suggestions.clear();
