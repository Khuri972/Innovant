...
public class SearchReciverPersonAdapter extends BaseAdapter implements Filterable {

    private Context context;
    public List<SearchModel> suggestions;
    private LayoutInflater inflater1 = null;

    public SearchReciverPersonAdapter(Context context) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                try {
                    ...
                    if (constraint != null) {
                        ...
                        List<SearchModel> new_suggestions = jp.searReciverPerson(constraint.toString());
                        suggestions.clear();
