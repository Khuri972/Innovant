 ...
 */
public class CompanyContactHistoryAdapter extends RecyclerView.Adapter<CompanyContactHistoryAdapter.ViewHolder> {
    private ArrayList<CompanyContactHistoryModel> data;
    private Context context;
    MyPreferences myPreferences;
    AlertDialog buildInfosDialog;

    public CompanyContactHistoryAdapter(Context context, ArrayList<CompanyContactHistoryModel> data) {
        this.data = data;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        viewHolder.name.setText(data.get(i).getCompany_name());

        StringBuilder address = new StringBuilder();

        if (!data.get(i).getCompany_address().equals("")) {
            address.append("" + data.get(i).getCompany_address()).append(",");
        }

        if (!data.get(i).getCompany_area().equals("")) {
            address.append("" + data.get(i).getCompany_area()).append(",");
        }
        if (!data.get(i).getCompany_zone_name().equals("")) {
            address.append("" + data.get(i).getCompany_zone_name()).append(",");
        }

        if (!data.get(i).getCompany_state_name().equals("")) {
            address.append("" + data.get(i).getCompany_state_name()).append(",");
        }
        if (!data.get(i).getCompany_country_name().equals("")) {
            address.append("" + data.get(i).getCompany_country_name()).append(",");
        }

        viewHolder.address.setText("" + GlobalElements.getRemoveLastComma("" + address.toString()));
        viewHolder.mobile.setText("" + data.get(i).getCompany_mobile());
        viewHolder.email.setText("" + data.get(i).getCompany_email());

        if (data.get(i).getCompany_mobile().equals("")) {
        ...
        viewHolder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, CompanyContactDetail.class);
        ...
        viewHolder.callImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!data.get(i).getCompany_mobile().equals("")) {
                    ...
                    intent.setData(Uri.parse("tel:" + data.get(i).getCompany_mobile()));
    ...
    public void shareContact(final int position) {
        try {
            ...
            textShare.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (data.get(position).getCompany_mobile().equals("")) {
                        Toaster.show(context, "Mobile number is empty", false, Toaster.DANGER);
                    } else if (data.get(position).getCompany_name().equals("")) {
                        ...
                        try {
                            ...
                            StringBuilder address = new StringBuilder();
                            if (!data.get(position).getCompany_address().equals("")) {
                                address.append("" + data.get(position).getCompany_address()).append(",");
                            }
                            if (!data.get(position).getCompany_area().equals("")) {
                                address.append("" + data.get(position).getCompany_area()).append(",");
                            }
                            if (!data.get(position).getCompany_city_name().equals("")) {
                                address.append("" + data.get(position).getCompany_city_name()).append(",");
                            }
                            if (!data.get(position).getCompany_pincode().equals("")) {
                                address.append("" + data.get(position).getCompany_pincode()).append(",");
                            }
                            share.putExtra(Intent.EXTRA_TEXT, "C Name : " + data.get(position).getCompany_name() + "\nMobile : " + data.get(position).getCompany_mobile() +"\nEmail : "+data.get(position).getCompany_email()+ "\naddress : " + GlobalElements.getRemoveLastComma("" + address.toString()));
                ...
                public void onClick(View view) {
                    try {
                        if (data.get(position).getCompany_mobile().equals("")) {
                            ...
                            fw.write("FN:" + data.get(position).getCompany_name() + "\r\n");
                            //  fw.write("ORG:" + p.getCompanyName() + "\r\n");
                            //  fw.write("TITLE:" + p.getTitle() + "\r\n");
                            fw.write("TEL;TYPE=WORK,VOICE:" + data.get(position).getCompany_mobile() + "\r\n");
