 ...
 */
public class CompanyPersonHistoryAdapter extends RecyclerView.Adapter<CompanyPersonHistoryAdapter.ViewHolder> {
    ...
    public CompanyPersonHistoryAdapter(Context context, ArrayList<IndividualContactHistoryModel> data, String company_id) {
        this.data = data;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        if (!data.get(i).getPerson_home_address().equals("")) {
            address.append("" + data.get(i).getPerson_home_address()).append(",");
        }
        if (!data.get(i).getPerson_city_name().equals("")) {
            address.append("" + data.get(i).getPerson_city_name()).append(",");
        }
        if (!data.get(i).getPerson_district_name().equals("")) {
            address.append("" + data.get(i).getPerson_district_name()).append(",");
        }
        if (!data.get(i).getPerson_state_name().equals("")) {
            address.append("" + data.get(i).getPerson_state_name()).append(",");
        }
        if (!data.get(i).getPerson_country_name().equals("")) {
            address.append("" + data.get(i).getPerson_country_name()).append(",");
        }
        if (!data.get(i).getPerson_pincode().equals("")) {
            address.append("" + data.get(i).getPerson_pincode()).append(",");
        }
        ...
        viewHolder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(context, AddCompanyPersonActivity.class);
                ...
                public void onClick(View view) {
                    if (data.get(position).getPerson_mobile().equals("")) {
                        ...
                        try {
                            ...
                            if (!data.get(position).getPerson_area().equals("")) {
                                address.append("" + data.get(position).getPerson_area()).append(",");
                            }
                            if (!data.get(position).getPerson_city_name().equals("")) {
                                address.append("" + data.get(position).getPerson_city_name()).append(",");
                            }
                            if (!data.get(position).getPerson_district_name().equals("")) {
                                address.append("" + data.get(position).getPerson_district_name()).append(",");
                            }
                            if (!data.get(position).getPerson_state_name().equals("")) {
                                address.append("" + data.get(position).getPerson_state_name()).append(",");
                            }
                            if (!data.get(position).getPerson_country_name().equals("")) {
                                address.append("" + data.get(position).getPerson_country_name()).append(",");
                            }
                            if (!data.get(position).getPerson_pincode().equals("")) {
                                address.append("" + data.get(position).getPerson_pincode()).append(",");
                            }
