...
public class SearchReciverCompanyAdapter extends BaseAdapter implements Filterable {

    private Context context;
    public List<SearchModel> suggestions;
    private LayoutInflater inflater1 = null;

    public SearchReciverCompanyAdapter(Context context) {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                try {
                    ...
                    if (constraint != null) {
                        ...
                        List<SearchModel> new_suggestions = jp.searReciverCompany(constraint.toString());
                        suggestions.clear();
