...
public class SubCategoryModel implements Serializable{
    ...
    int id,cid,display_order;
    String name,slug,image_path,banner_image_path,attr,descr;

    public ArrayList<SubSubCategoryModel> getSubsubcategory() {
        return subsubcategory;
    }

    public void setSubsubcategory(ArrayList<SubSubCategoryModel> subsubcategory) {
        this.subsubcategory = subsubcategory;
    }

    ArrayList<SubSubCategoryModel> subsubcategory;
