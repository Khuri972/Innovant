...
public class SearchItemAdapter extends BaseAdapter implements Filterable {
    ...
    public List<ProductModel> suggestions;
    private LayoutInflater inflater1 = null;
    String customer_id="";
    public SearchItemAdapter(Context context,String customer_id) {
        this.context = context;
        suggestions = new ArrayList<ProductModel>();
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                try {
                    ...
                    if (constraint != null) {
                        ...
                        List<ProductModel> new_suggestions = jp.searItem(constraint.toString(),customer_id);
                        suggestions.clear();
