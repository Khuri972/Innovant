...
public class SalesReturnModel implements Serializable{
    ...
    public void setSales_return_no(String sales_return_no) {
        this.sales_return_no = sales_return_no;
    }
    ...
    public String getSales_return_format() {
        return sales_return_format;
    }

    public void setSales_return_format(String sales_return_format) {
        this.sales_return_format = sales_return_format;
    }

    String sales_return_format;
    String narration;
