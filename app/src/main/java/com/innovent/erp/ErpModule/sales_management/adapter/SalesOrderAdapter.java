...
public class SalesOrderAdapter extends RecyclerView.Adapter<SalesOrderAdapter.ViewHolder> {
    ...
    private ArrayList<SalesOrderModel> data;
    private Context context;
    MyPreferences myPreferences;

    public SalesOrderAdapter(Context context, ArrayList<SalesOrderModel> data) {
        this.data = data;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        try {
            ...
            viewHolder.quatationNo.setText("Order No : " + data.get(i).getOrder_no());
            ...
            viewHolder.quatationDate.setText("Order Date : " + data.get(i).getOrder_date_format());
    ...
    private void deleteQuatation(String id, final int position) {
        ...
        Call<ResponseBody> call = req.deleteQuatationRequest(myPreferences.getPreferences(MyPreferences.id), id, "order");
