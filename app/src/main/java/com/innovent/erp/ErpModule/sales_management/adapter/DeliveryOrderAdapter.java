...
public class DeliveryOrderAdapter extends RecyclerView.Adapter<DeliveryOrderAdapter.ViewHolder> {
    ...
    private ArrayList<DeliveryOrderModel> data;
    private Context context;
    MyPreferences myPreferences;

    public DeliveryOrderAdapter(Context context, ArrayList<DeliveryOrderModel> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_delivery_order_history, viewGroup, false);
