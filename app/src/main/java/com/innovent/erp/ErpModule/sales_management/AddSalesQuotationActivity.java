...
public class AddSalesQuotationActivity extends AppCompatActivity implements QuatationRequestProductAdapter.Intercommunicator {
    ...
    String toolbarTitle = "Sales Quotation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            cityAdapter = new GeneralAdapter(AddSalesQuotationActivity.this, city_data);
            ...
            districtAdapter = new GeneralAdapter(AddSalesQuotationActivity.this, district_data);
            ...
            stateAdapter = new GeneralAdapter(AddSalesQuotationActivity.this, state_data);
            ...
            countryAdapter = new GeneralAdapter(AddSalesQuotationActivity.this, country_data);
            ...
            zoneAdapter = new GeneralAdapter(AddSalesQuotationActivity.this, zone_data);
        ...
        mItem = new ArrayList<>();
        searchAdapter = new SearchAdapter(AddSalesQuotationActivity.this, mItem);
        listContainer.setAdapter(searchAdapter);
        searchAdapter.notifyDataSetChanged();

        adapter = new QuatationRequestProductAdapter(AddSalesQuotationActivity.this, data);
        recycleview.setAdapter(adapter);
        recycleview.setLayoutManager(new LinearLayoutManager(AddSalesQuotationActivity.this, LinearLayoutManager.VERTICAL, false));
        ...
        try {
            ...
            if (insert_update_flag.equals("0")) {
                submit.setText("Create Quotation");
            } else {
                toolbarTitle = "Update Sales Quotation";
                model = (QuatationRequestModel) bundle.getSerializable("quotation_data");
                data = (ArrayList<ProductModel>) bundle.getSerializable("product_data");
                position = bundle.getInt("position");
                submit.setText("Update Quotation");
                dateEdt.setText("" + model.getQuotation_request_date_format());
        ...
        dateEdt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    datePicker = new CustomDatePicker(AddSalesQuotationActivity.this);
        ...
        customerAdapter = new SearchCustomerAdapter(AddSalesQuotationActivity.this);
        customerName.setAdapter(customerAdapter);

        itemAdapter = new SearchItemAdapter(AddSalesQuotationActivity.this, customerId);
        ...
        searchItemEdt.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    ...
                    getTotalQty();
                    getTotalAmount();
                    InputMethodManager imm = (InputMethodManager) AddSalesQuotationActivity.this.getSystemService(AddSalesQuotationActivity.this.INPUT_METHOD_SERVICE);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (GlobalElements.isConnectingToInternet(AddSalesQuotationActivity.this)) {
                    int add_flag = 0;
                    JSONObject user;
                    ...
                    for (int i = 0; i < data.size(); i++) {
                        ...
                        if (data.get(i).getQty() == 0) {
                            add_flag = 1;
                            Toaster.show(AddSalesQuotationActivity.this, "Enter Qty", true, Toaster.DANGER);
                            break;
                        }
                        if (data.get(i).getSell_price() == 0) {
                            add_flag = 1;
                            Toaster.show(AddSalesQuotationActivity.this, "Enter Rate", true, Toaster.DANGER);
                            break;
                        } else {
                            try {
                                user.put("item_id", "" + id);
                    ...
                    if (add_flag == 0) {
                        Toaster.show(AddSalesQuotationActivity.this, "Add Item", true, Toaster.DANGER);
                    } else if (add_flag == 2) {
                        AlertDialog buildInfosDialog;
                        AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(AddSalesQuotationActivity.this);
                        if (insert_update_flag.equals("0")) {
                            alertDialog2.setTitle("Are you sure want create Quotation request");
                        } else {
                            alertDialog2.setTitle("Are you sure want update Quotation request");
                        }
                        ...
                        alertDialog2.setPositiveButton("Yes",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        try {
                                            if (GlobalElements.isConnectingToInternet(AddSalesQuotationActivity.this)) {
                                                addQuatationRequest("" + json_array.toString());
                                            } else {
                                                GlobalElements.showDialog(AddSalesQuotationActivity.this);
                                            }
                                        } catch (Exception e) {
                                            e.printStackTrace();
                                        }
    ...
    private void InitiateToolbarTabs() {
        toolbar.setTitleTextColor(AddSalesQuotationActivity.this.getResources().getColor(R.color.white));
                        ...
                        try {
                            if (data.size() > 0) {
                                ...
                                if (chk_flag) {
                                    ...
                                    AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(AddSalesQuotationActivity.this);
                                    LayoutInflater inflater = AddSalesQuotationActivity.this.getLayoutInflater();
                                    ...
                                    ok.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (d_product_discount.getText().toString().equals("")) {
                                                Toaster.show(AddSalesQuotationActivity.this, "Enter Discount Amount", true, Toaster.DANGER);
                                            } else {
                                                try {
        ...
        clearSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextSearch.getText().toString().length() == 0) {
                    ...
                    ((InputMethodManager) AddSalesQuotationActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(InputMethodManager.SHOW_FORCED, InputMethodManager.HIDE_IMPLICIT_ONLY);
                }
            }
        });
    }
        ...
        imageSearchBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    initiateSearch.handleToolBar(AddSalesQuotationActivity.this, cardSearch, toolbar, editTextSearch, toolbarTitle, R.menu.quatation_create);
                ...
                try {
                    ...
                    View view = AddSalesQuotationActivity.this.getCurrentFocus();
                    if (view != null) {
    ...
    private void addQuatationRequest(String items) {
        try {
            final ProgressDialog pd = new ProgressDialog(AddSalesQuotationActivity.this);
            ...
            if (insert_update_flag.equals("0")) {
                call = request.addQuatationRequest(myPreferences.getPreferences(MyPreferences.id), customerId, customerName.getText().toString(), customerEmailEdt.getText().toString(),
                ...
                call = request.updateQuatationRequest(myPreferences.getPreferences(MyPreferences.id), customerId, customerName.getText().toString(), customerEmailEdt.getText().toString(),
                        customerMobileEdt.getText().toString(), customerAlterMobileEdt.getText().toString(), customerAddress1Edt.getText().toString(), customerAddress2Edt.getText().toString(),
                        customerLandmarkEdt.getText().toString(), cityId, stateId, countryId,
                        customerPincodeEdt.getText().toString(), zoneId, customerAreaEdt.getText().toString(), districtId, "", customerGstEdt.getText().toString(),
                        customerPancardEdt.getText().toString(), GlobalElements.getDateFrom_YYYY_MM(), narrationEdt.getText().toString(), termsEdt.getText().toString(), "" + discount, "" + discount_type, items, model.getId());
            }
                    ...
                    try {
                        ...
                        if (json.getInt("ack") == 1) {
                            if (insert_update_flag.equals("0")) {
                                ...
                                model.setQuotation_request_no("" + result.getString("quotation_no"));
                                ...
                                model.setQuotation_request_date_format(result.getString("quotation_date"));
                                ...
                                for (int i = 0; i < items.length(); i++) {
                                    ...
                                    da.setSell_price(c.getDouble("sell_price"));
                            ...
                            Toaster.show(AddSalesQuotationActivity.this, "" + json.getString("ack_msg"), false, Toaster.DANGER);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
