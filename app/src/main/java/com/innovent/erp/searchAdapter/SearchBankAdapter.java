package com.innovent.erp.searchAdapter;
...
public class SearchBankAdapter extends BaseAdapter implements Filterable {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                try {
                    ...
                    if (constraint != null) {
                        ...
                        List<SearchModel> new_suggestions = jp.searBank(constraint.toString());
                        suggestions.clear();
