...
public class ServiceInvoiceModel implements Serializable{
    ...
    public String getInvoice_date_format() {
        return invoice_date_format;
    }

    public void setInvoice_date_format(String invoice_date_format) {
        this.invoice_date_format = invoice_date_format;
    }

    String invoice_date_format;
    String narration;
