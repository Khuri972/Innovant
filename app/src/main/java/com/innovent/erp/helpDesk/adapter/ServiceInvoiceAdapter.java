...
import com.innovent.erp.ErpModule.sales_management.OrderDetailActivity;
...
import com.innovent.erp.helpDesk.ServiceInvoiceDetailActivity;
 ...
 */
public class ServiceInvoiceAdapter extends RecyclerView.Adapter<ServiceInvoiceAdapter.ViewHolder> {


    private ArrayList<ServiceInvoiceModel> data;
    private Context context;
    MyPreferences myPreferences;

    public ServiceInvoiceAdapter(Context context, ArrayList<ServiceInvoiceModel> data) {
        this.data = data;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_sales_order_history, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        try {
            ...
            viewHolder.quatationNo.setText("Invoice No : " + data.get(i).getInvoice_no());
            ...
            viewHolder.quatationDate.setText("Invoice Date : " + data.get(i).getInvoice_date_format());
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (GlobalElements.isConnectingToInternet(context)) {
                                            deleteSeriveInvoice(data.get(i).getId(), i);
                                        } else {
            ...
            viewHolder.layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        Intent intent = new Intent(context, ServiceInvoiceDetailActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("position", i);
                        bundle.putString("invoice_id", data.get(i).getId());
                        bundle.putString("invoice_no", data.get(i).getInvoice_no());
    ...
    private void deleteSeriveInvoice(String id, final int position) {
        ...
        Call<ResponseBody> call = req.deleteServiceInvoice(myPreferences.getPreferences(MyPreferences.id), id);
